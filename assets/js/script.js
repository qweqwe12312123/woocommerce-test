$(function(){
    ...
    $('.item__carousel').slick({
        prevArrow: "<img src='https://e13.boutique/wp-content/uploads/2023/01/angle-left-svgrepo-com.svg' class='prev' alt='1'>",
        nextArrow: "<img src='https://e13.boutique/wp-content/uploads/2023/01/angle-right-svgrepo-com.svg' class='next' alt='2'>",
    ...
    $('.slct').click(function(){
        ...
        var arrowImg = "<img class='arrow__img' src='https://e13.boutique/wp-content/uploads/2023/01/down-arrow.svg' alt=''>"
        ...
        if( dropBlock.is(':hidden') ) {
            ...
            $('.drop').find('li').click(function(){
                ...
                $(this).parent().parent().find('button').val(selectResult);
...
$(document).ready(function(){
    ...
    //     var url = form.action + '?' + new FormData(form).toString();
    //     fetch(url)
